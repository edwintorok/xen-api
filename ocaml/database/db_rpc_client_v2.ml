...
functor
  ...
  struct
    ...
    let process_structured_field _ a b c d e =
      ...
      | Response.Process_structured_field y ->
          y
      | _ ->
          raise Remote_db_server_returned_bad_message
  end
