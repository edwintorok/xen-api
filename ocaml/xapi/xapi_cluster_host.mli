...
val fix_pif_prerequisites : __context:Context.db Context.t -> API.ref_PIF -> unit
...
val sync_required :
  __context:Context.db Context.t -> host:API.ref_host -> API.ref_Cluster option
...
val create_as_necessary : __context:Context.db Context.t -> host:API.ref_host -> unit
...
val force_destroy : __context:Context.db Context.t -> self:API.ref_Cluster_host -> unit
...
val destroy : __context:Context.db Context.t -> self:API.ref_Cluster_host -> unit
...
val enable : __context:Context.db Context.t -> self:API.ref_Cluster_host -> unit
...
val disable : __context:Context.db Context.t -> self:API.ref_Cluster_host -> unit
...
val disable_clustering : __context:Context.db Context.t -> unit
...
val resync_host : __context:Context.db Context.t -> host:API.ref_host -> unit
...
val forget : __context:Context.db Context.t -> self:API.ref_Cluster_host -> unit
...
val set_tls_config :
  __context:Context.db Context.t -> self:API.ref_Cluster_host -> verify:bool -> unit
