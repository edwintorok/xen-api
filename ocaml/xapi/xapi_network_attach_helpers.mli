...
val assert_pif_disallow_unplug_not_set :
  __context:Context.db Context.t -> [`PIF] Ref.t -> unit
...
val assert_no_slave : __context:Context.db Context.t -> [`PIF] Ref.t -> unit
...
val assert_can_attach_network_on_host :
  __context:Context.db Context.t -> self:[`network] Ref.t -> host:[`host] Ref.t -> unit
(** Raises an exception if the network cannot be attached. *)

val assert_valid_ip_configuration_on_network_for_host :
  __context:Context.db Context.t -> self:[`network] Ref.t -> host:[`host] Ref.t -> string
