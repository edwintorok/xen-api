...
let xapi_globs_spec =
  ...
  ; ("redo_log_max_startup_time", ShortDurationFromSeconds Db_globs.redo_log_max_startup_time)
  ; ("redo_log_connect_delay", ShortDurationFromSeconds Db_globs.redo_log_connect_delay)
