...
val destroy : __context:Context.db Context.t -> self:[`Bond] Ref.t -> unit
...
val set_mode :
  __context:Context.db Context.t -> self:[`Bond] Ref.t -> value:API.bond_mode -> unit
...
val fix_bond : __context:Context.db Context.t -> bond:[`Bond] Ref.t -> unit
