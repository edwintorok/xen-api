...
module Response = struct
  ...
  let create zb reader input callback =
  ...
  let finish t =
    ...
    t.headers_size <- 0;
    t.content_length <- 0;
    t.callback ~status_code ~content_length ~headers_size
