...
module Swtpm : sig
  ...
  val restore : string -> domid:int -> vtpm_uuid:Varstore_privileged_interface.Uuidm.t -> string -> unit

  val suspend : string -> xs:Xenstore.Xs.xsh -> domid:int -> vtpm_uuid:Varstore_privileged_interface.Uuidm.t -> string
